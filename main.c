...
///// CREANDO LOS FORK AQUI POR QUE ASI TODOS LOS PROCESOS TIENEN ACCESO A LA INFORMACION DE LOS PRODUCTOS (pero no a la lista de pedidos)


////// P R O C E S O    H I J O  1 /////////////////////////////////////////////////////////////////////////////////// 1
    repartidor1=fork();
    sleep(1);
    if (repartidor1 < 0){ //Ocurrio un error
        ...
        sleep(1);
        int pedido;
//        while(pedido!=FINISHED){
//
//        }
        read(data1[0], &pedido, sizeof(int));
        printf("\n child 1 WAITING for pedido %d \n", pedido);
        sleep(1);
        printf("\n child 1 FINISHED pedido %d \n", pedido);
        pedido=DONE;
        sleep(1);
        write(data1[1], &pedido, sizeof(int ));
    }

    else {
////// P R O C E S O    H I J O  2 /////////////////////////////////////////////////////////////////////////////////// 2
        repartidor2 = fork();
        sleep(1);
...
//            write(data1[1], &prod1, sizeof(int));
            ...
            while (pedidosDone != pedidosCount) {
                printf("PedidosDone %d | PedidosCount %d\n",pedidosDone,pedidosCount);
